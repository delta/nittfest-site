    ...
    >
      <div className={styles.wrapper}>
        ...
        <div className={`${styles.slide} ${styles.five}`}>
          <img src={forest00} alt="forest" className={styles.forest} />
          <img src={forest0} alt="forest" className={styles.forest} />
          <img src={forest1} alt="forest" className={styles.forest} />
        </div>
        ...
        <div className={`${styles.slide} ${styles.seven}`}>
          <img src={rainbowbg} alt="rainbowbg" className={styles.rainbowbg} />
          <img src={road} alt="road" className={styles.road} />
          <img src={foliage} alt="foliage" className={styles.foliage} />
        </div>
